<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div> <!--เพิ่มฟิลรับเบอร์โทรศัพท์ -->
                <x-label for="phone_number" value="{{ __('phone_number') }}" />
                <x-input id="phone_number" class="block mt-1 w-full" type="integer" name="phone_number" :value="old('phone_number')" required autofocus autocomplete="phone_number" />
            </div>

            <div> <!--เพิ่มฟิลรับที่อยู่ -->
